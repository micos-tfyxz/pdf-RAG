...
if __name__ == "__main__":
    ...
    bot.load_pdf("  ", max_chunk_size=600) # Add the path to your PDF file
    
    # Build vector index
    bot.build_index()
    
    # Perform query
    results = bot.query_with_context("  ", top_k=2, 
                                     similarity_ratio=0.85, min_return_threshold=0.60) # Add your question
